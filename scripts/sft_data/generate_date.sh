#!/bin/bash
# Bash wrapper to generate current date training data
# Usage: ./scripts/sft_data/generate_date.sh [options]
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}Date Data Generation${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
